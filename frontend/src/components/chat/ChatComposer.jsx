  ...
  return (
    <form className="composer" onSubmit={e => { e.preventDefault(); if (input.trim()) onSend(); }}>
      <div className="composer-surface" data-state={isSending ? 'sending' : undefined}>
        <button
          type="button"
          className="icon-btn composer-icon-btn"
          aria-label="Add attachment"
          onClick={() => { /* placeholder for attachment logic */ }}
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M21.44 11.05 12.53 20.96a4 4 0 0 1-5.66 0 4 4 0 0 1 0-5.66l8.9-8.9a2.83 2.83 0 0 1 4 4l-7.07 7.07a1 1 0 0 1-1.41-1.41l6.36-6.36" />
          </svg>
        </button>
